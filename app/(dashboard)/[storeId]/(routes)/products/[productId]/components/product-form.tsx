...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const onSubmit = async (data: ProductFormValues) => {
    try {
      ...
      toast.error("Ha ocurrio algun error.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const onDelete = async () => {
    try {
      ...
      console.log(error);
      toast.error("Algun error ocurrio al tratar de eliminar el producto");
    } finally {
      setLoading(false);
      setOpen(false);
    }
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Este producto aparecera en la pagina de inicio
                    </FormDescription>
                  </div>
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Este producto no aparecera en ninguna parte de la tienda
                    </FormDescription>
                  </div>
                </FormItem>
              )}
